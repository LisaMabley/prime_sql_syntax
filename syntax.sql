...
-- The bank is giving a new customer bonus! Update all records with an account balance of 0.00
...
-- Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed,
  transactions_attempted, account_balance, user_id)
VALUES('ryan', 'minneapolis', 20, 22, 10000000, 9);
